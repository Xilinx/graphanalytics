...
set -e
echo "******** SOFTWARE-ONLY INSTALLATION! ********"
...
cp tigergraph/QueryUdf/xilinxUdfSw.hpp tigergraph/QueryUdf/ExprFunctions.hpp
...
cp -rf tigergraph/QueryUdf/coreSw.cpp $tg_root_dir/dev/gdk/gsql/src/QueryUdf/
cp -rf tigergraph/QueryUdf/core.hpp $tg_root_dir/dev/gdk/gsql/src/QueryUdf/
...
cp -rf tigergraph/QueryUdf/core.hpp $tg_temp_root/gsql/codegen/udf
...
cp -rf tigergraph/MakeUdfSw $tg_root_dir/dev/gdk/MakeUdf
...
echo "Remember: this is a SOFTWARE ONLY installation - no FPGA implementation!"
