...
#ifndef TRAVELPLAN_DEMO_IMPL_HPP
#define TRAVELPLAN_DEMO_IMPL_HPP

#include <chrono>

namespace travelPlanDemo {

using Mutex = xilMis::Mutex;
using Lock = xilMis::Lock;
...
#endif /* TRAVELPLAN_DEMO_IMPL_HPP */
