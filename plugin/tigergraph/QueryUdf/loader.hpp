...
int load_cu_cosinesim_ss_dense_fpga_wrapper(uint32_t deviceNeeded, uint32_t cuNm);
int load_graph_cosinesim_ss_dense_fpga_wrapper(uint32_t deviceNeeded, uint32_t cuNm, 
                                               xf::graph::Graph<int32_t, int32_t>** graph);
