...
FRAME_DIR_LIST = {"/proj/gdba/tools/doxyrest-2.1.2/share/doxyrest/frame/cfamily", 
                  "/proj/gdba/tools/doxyrest-2.1.2/share/doxyrest/frame/common"}
...
INDEX_TITLE = "Xilinx Recommendation Engine for TigerGraph 3.x"
