...
#include "denseSimilarityKernel4PU.hpp"
...
extern "C" void denseSimilarityKernel4PU(ap_int<32>* config,
...
#pragma HLS INTERFACE m_axi offset = slave latency = 32 num_write_outstanding = 1 num_read_outstanding = \
    8 max_write_burst_length = 16 max_read_burst_length = 64 bundle = gmem3_0 port = dataIn30 depth = ext_mem_size
#pragma HLS INTERFACE s_axilite port = dataIn30 bundle = control
#pragma HLS INTERFACE m_axi offset = slave latency = 32 num_write_outstanding = 1 num_read_outstanding = \
    8 max_write_burst_length = 16 max_read_burst_length = 64 bundle = gmem3_1 port = dataIn31 depth = ext_mem_size
#pragma HLS INTERFACE s_axilite port = dataIn31 bundle = control
#pragma HLS INTERFACE m_axi offset = slave latency = 32 num_write_outstanding = 1 num_read_outstanding = \
    8 max_write_burst_length = 16 max_read_burst_length = 64 bundle = gmem3_2 port = dataIn32 depth = ext_mem_size
#pragma HLS INTERFACE s_axilite port = dataIn32 bundle = control
#pragma HLS INTERFACE m_axi offset = slave latency = 32 num_write_outstanding = 1 num_read_outstanding = \
    8 max_write_burst_length = 16 max_read_burst_length = 64 bundle = gmem3_3 port = dataIn33 depth = ext_mem_size
#pragma HLS INTERFACE s_axilite port = dataIn33 bundle = control

#pragma HLS INTERFACE m_axi offset = slave latency = 32 num_write_outstanding = 1 num_read_outstanding = \
    8 max_write_burst_length = 16 max_read_burst_length = 64 bundle = gmem0_0 port = config depth = 64
#pragma HLS INTERFACE s_axilite port = config bundle = control
#pragma HLS INTERFACE m_axi offset = slave latency = 32 num_write_outstanding = 1 num_read_outstanding = \
    8 max_write_burst_length = 16 max_read_burst_length = 64 bundle = gmem0_0 port = sourceWeight depth = 65536
#pragma HLS INTERFACE s_axilite port = sourceWeight bundle = control
#pragma HLS INTERFACE m_axi offset = slave latency = 32 num_write_outstanding = 1 num_read_outstanding = \
    8 max_write_burst_length = 16 max_read_burst_length = 64 bundle = gmem0_0 port = sourceCoeffs depth = 65536
#pragma HLS INTERFACE s_axilite port = sourceCoeffs bundle = control
#pragma HLS INTERFACE m_axi offset = slave latency = 32 num_write_outstanding = 1 num_read_outstanding = \
    8 max_write_burst_length = 16 max_read_burst_length = 64 bundle = gmem0_0 port = resultID depth = 128
#pragma HLS INTERFACE s_axilite port = resultID bundle = control
#pragma HLS INTERFACE m_axi offset = slave latency = 32 num_write_outstanding = 1 num_read_outstanding = \
    8 max_write_burst_length = 16 max_read_burst_length = 64 bundle = gmem0_0 port = similarity depth = 128
