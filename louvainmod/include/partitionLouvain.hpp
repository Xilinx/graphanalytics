...
public:
	...
	void EdgePruning(edge* edges, long head, long tail, double weight, long* M_g, VGMinDgr& min, long& num_vg, long& e_dgr, int th_maxGhost);
...
void   cmd_runMultiPhaseLouvainAlgorithm(GLV* pglv, GLV* pglv_iter, long minGraphSize, double threshold, double C_threshold, int numPhase);
void   cmd_runMultiPhaseLouvainAlgorithm(GLV* pglv, GLV* pglv_iter, long minGraphSize, double threshold, double C_threshold, bool isNoParallelLouvain, int numPhase);
GLV* cmd_runMultiPhaseLouvainAlgorithm(GLV* pglv, int& id_glv, long minGraphSize, double threshold, double C_threshold, bool isNoParallelLouvain, int numPhase);
GLV* cmd_runMultiPhaseLouvainAlgorithm(GLV* pglv, int& id_glv, long minGraphSize, double threshold, double C_threshold, int numPhase);
double cmd_lv_parallelLouvianMethod(graphNew *G, long *C, long *M, int nThreads, double Lower, double thresh, double *totTime, int *numItr);
